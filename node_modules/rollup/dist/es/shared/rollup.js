...
function amd(magicString, { accessedGlobals, dependencies, exports, hasExports, id, indent: t, intro, isEntryFacade, isModuleFacade, namedExportsMode, outro, snippets, warn }, { amd, esModule, externalLiveBindings, freeze, interop, namespaceToStringTag, strict }) {
    ...
    const deps = renderChunkId
        ? renderChunkId(dependencies)
        : dependencies.map(m => `'${updateExtensionForRelativeAmdId(m.id, amd.forceJsExtensionForImports)}'`);
    ...
    const completeAmdId = renderChunkId ? renderChunkId(id) : getCompleteAmdId(amd, id);
...
const getAmd = (config) => {
    ...
    if (mergedOption.autoId) {
        normalized = {
            ...
            renderChunkId: (_a = config.amd) === null || _a === void 0 ? void 0 : _a.renderChunkId
        };
    }
    else {
        normalized = {
            ...
            forceJsExtensionForImports: mergedOption.forceJsExtensionForImports,
            id: mergedOption.id,
            renderChunkId: (_b = config.amd) === null || _b === void 0 ? void 0 : _b.renderChunkId
        };
    }
    return normalized;
};
...
export { createFilter, defaultOnWarn, defineConfig, ensureArray, fseventsImporter, generatedCodePresets, getAugmentedNamespace, nodeConstructors, objectifyOption, objectifyOptionWithPresets, picomatch$1 as picomatch, rollup, rollupInternal, treeshakePresets, version$1 as version, warnUnknownOptions, watch };
